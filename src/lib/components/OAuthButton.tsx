...
export function OAuthButton({
  ...
  return (
    <div className="space-y-2">
      <Button
        ...
        leftIcon={
          loading ? (
            ...
            <span className="md3-title-medium">{getProviderIcon()}</span>
          )
        }
      >
        {loading ? (
      ...
      {error && (
        <div className="p-2 bg-[var(--md-sys-color-error-container)] border border-[var(--md-sys-color-error)] rounded-md text-[var(--md-sys-color-on-error-container)] md3-body-small flex items-center space-x-2">
  ...
  return (
    <div className={`space-y-3 ${className || ''}`}>
      <div className="relative">
        ...
        <div className="relative flex justify-center md3-body-small">
...
export function OAuthAccountManager({
  ...
  return (
    <div className="space-y-4">
      <h3 className="md3-title-large font-medium text-[var(--md-sys-color-on-surface)]">Connected Accounts</h3>
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                <span className="md3-headline-medium">{provider.name === 'google' ? '🔍' : provider.name === 'github' ? '🐙' : '🔐'}</span>
                <div>
